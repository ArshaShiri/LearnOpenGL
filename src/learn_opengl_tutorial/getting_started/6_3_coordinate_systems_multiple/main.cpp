...
int main()
{
    ...
    const auto vertexShaderFilePath = std::filesystem::current_path().append(
      "src/learn_opengl_tutorial/getting_started/6_3_coordinate_systems_multiple/vertex_shader.vs");
    ...
    const auto fragmentShaderFilePath = std::filesystem::current_path().append(
      "src/learn_opengl_tutorial/getting_started/6_3_coordinate_systems_multiple/fragment_shader.fs");
