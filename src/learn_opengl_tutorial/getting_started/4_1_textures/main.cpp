...
int main()
{
    ...
    const auto vertexShaderFilePath =
      std::filesystem::current_path().append("src/learn_opengl_tutorial/getting_started/4_1_textures/vertex_shader.vs");
    // const auto vertexShaderFilePath = std::filesystem::current_path().append("vertex_shader.vs");
    const auto vertexShader = Shader(ShaderType::Vertex, "", vertexShaderFilePath);

    // const auto fragmentShaderFilePath = std::filesystem::current_path().append("fragment_shader.fs");
    const auto fragmentShaderFilePath = std::filesystem::current_path().append(
      "src/learn_opengl_tutorial/getting_started/4_1_textures/fragment_shader.fs");
